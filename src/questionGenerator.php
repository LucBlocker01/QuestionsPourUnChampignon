...
function generateQuestions($difficulty) {
    switch ($difficulty) {
        ...
        case "hard" :
            $dataQ = [
                ["Un homme peut-il épouser la soeur de sa veuve?", ["Oui", "Non", "Dans certains pays", "Cela dépend", "Sous certaines conditions"], 1],
                ["Quel est la valeur de Pi au millième près?", ["3,141", "3,142", "3,145", "3,147", "3,143"], 0],
                ["Combien de mois ont 28 jours?", ["1", "2", "12", "0", "3"], 2],
                ["Dans une course, dans quelle position êtes-vous après avoir doublé la personne en 3ème place?", ["1er", "4ème", "2ème", "3ème", "5ème"], 3],
                ["Quel est la capitale de l'Australie?", ["Melbourne", "Perth", "Sydney", "Brisbane", "Canberra"], 4],
                ["Combien de temps dure une journée sur Terre?", ["23h 56m", "24h", "24h 10m", "23h 50m", "25h"], 0],
                ["Lorsque l'on plie une feuille de papier 50 fois, quelle serait son épaisseur finale?", ["Quelques centimètres", "Quelques mètres", "La taille d'une maison", "Aussi haut que l'Everest", "Plus loin que la distance Terre-Lune"], 4],
                ["Que signifie le symbole suivant en maths? ∈", ["Union", "Si et seulement si", "Contient comme élément", "Appartient à", "Existe"], 3],
                ["Que vaux x? 3x+5=20", ["12", "18", "5", "15", "17"], 2],
                ["Quel est l'intrus?", ["Rouge", "Rose", "Violet", "Vert", "Bleu"], 1],
                ["Combien de côtés possède un pentadécagone?", ["5", "25", "16", "15", "Cette figure n'existe pas"], 3],
                ["Quel est la somme des angles d'un pentagone?", ["180", "360", "540", "270", "90"], 2],
                ["Quel est le principal gaz dans l'atmosphère terrestre?", ["Oxygène", "Azote", "Ozone", "Dioxyde de carbone", "Hélium"], 1],
                ["Quel élément chimique est représenté par 'K'?", ["Krypton", "Or", "Carbone", "Calcium", "Potassium"], 4],
                ["Quel est l'os le plus long du corps humain?", ["Tibia", "Humérus", "Fémur", "Radius", "Crâne"], 2],
                ["Quel phénomène naturel est mesuré par l'échelle de Richter?", ["Tornade", "Tremblement de Terre", "Tsunami", "Eruption", "Ouragan"], 1],
                ...
                ["Quel évènement a déclenché la 1ère Guerre Mondiale?", ["L'invasion de la Pologne", "Le bombardement de Pearl Harbor", "La Révolution russe", "La signature du traité de Versailles", "L'assassinat de François-Ferdinand"], 4],
                ["Qu'est-ce qui a causé la course à l'espace?", ["La découverte de nouvelles ressources sur la Lune", "Le besoin d'explorer d'autres planètes", "La recherche d'une nouvelle source d'énergie", "La compétition technologique entre les États-Unis et l'Union soviétique", "Les avancées dans la navigation aérienne"], 3],
                ["Qu'est-ce qu'une clé de sol?", ["Un type de guitare", "Un terme pour désigner un morceau de musique dans le ton de sol", "Une technique de jeu au piano", "Un symbole musical qui indique la hauteur des notes sur une portée", "Un élément de notation utilisé uniquement pour la musique vocale"], 3],
                ["Quel est le symbole du pound?", ["$", "₽", "€", "¥", "£"], 4],
                ["Qui a peint la Plage de Pourville?", ["Van Gogh", "Claude Monet", "Ludwig Knaus", "Léonard de Vinci", "Pablo Picasso"], 1],
                ["Quel lettre dans la langue française est la moins utilisé?", ["K", "Z", "Y", "W", "X"], 3],
                ["Que signifie 'cheval' en espagnol?", ["Gato", "Oveja", "Pez", "Conejo", "Caballo"], 4],
                ["Quel est le principal conducteur dans les fils électriques?", ["Or", "Fer", "Cuivre", "Zinc", "Plastique"], 2],
                ["Quel dispositif transforme l'énergie électrique en énergie lumineuse?", ["Résistance", "Condensateur", "Transistor", "Diode", "Ampoule"], 3],
                ["Quelle est la principale source de nourriture pour de nombreux animaux marins dans l'océan?", ["Zooplancton", "Débris organiques", "Plantes aquatiques", "Phytoplancton", "Poisson"], 3],
                ["Quel est l'impact principal du réchauffement climatique sur les océans?", ["Augmentation des niveaux de la mer", "Diminution des niveaux de salinité", "Acidification des océans", "Augmentation des courants océaniques", "Réduction des tempêtes océaniques"], 2],
                ["Quel est le plus grand réseau de catacombes au monde?", ["Catacombes de Paris", "Catacombes de Rome", "Catacombes de Naples", "Catacombes de Prague", "Catacombes de Lisbonne"], 2],
                ...
                ["Quel est la distance moyenne entre la Terre et le Soleil?", ["1 UA", "1,5 UA", "93 millions de kilomètres", "30 millions de kilomètres", "5 UA"], 0],
                ["Quel est la principale composante du noyau des étoiles?", ["Hydrogène", "Carbone", "Fer", "Hélium", "On ne sait pas"], 0],
