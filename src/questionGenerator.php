    ...
    switch ($difficulty) {
        ...
        case "hard" :
            $dataQ = [
                ...
                ["Que vaux x? 3x+5=20", ["12", "18", "5", "15", "17"], 3],
                ...
                ["Quest-ce qu'une clé de sol?", ["Un type de guitare", "Un terme pour désigner un morceau de musique dans le ton de sol", "Une technique de jeu au piano", "Un symbole musical qui indique la hauteur des notes sur une portée", "Un élément de notation utilisé uniquement pour la musique vocale"], 3],
